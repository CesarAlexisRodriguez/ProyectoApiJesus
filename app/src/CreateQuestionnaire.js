...
export const CreateQuestionnaire = () => {
    ...
    const onSubmit = async () => {
        try {
            ...
            await axios.post('http://localhost:4000/questionnaire/create', data);
        } catch (error) {
            alert("Hubo un error");
        }
    };
    ...
    const addOption = (index) => {
        const data = createQuestionnaire;
        data.questions[index].options.push(`Opción ${data.questions[index].options.length + 1}`);
        setCreateQuestionnaire({ ...data });
    };
            ...
            <form onSubmit={onSubmit}>
                ...
                </Card>
                {
                    createQuestionnaire.questions.map((q, i) => (
                        <Card className='mb-3' border='primary' key={i}>
                            <Card.Body>
                    ...
                    <Col>
                        <Row>
                            <Col className='text-center'>
                                ...
                                <Button onClick={() => onSubmit()} variant='success'>Guardar cuestionario</Button>
                            </Col>
                        </Row>
                    </Col>
                </Row>
